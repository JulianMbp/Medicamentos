    ...
    <main>
      ...
      <div className="p-6 bg-p-olivine-100 min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-p-olivine-50 p-6 rounded-lg shadow-lg transition-all duration-300 ease-in-out transform hover:scale-110 hover:border-4 hover:border-p-olivine-800 hover:shadow-2xl hover:shadow-p-olivine-700 hover:bg-p-olivine-200 hover:-translate-y-3">
